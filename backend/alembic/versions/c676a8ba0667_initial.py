...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_cohort_cluster_cluster_id", "cohort_cluster", ["cluster_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        "idx_lab_prov_cluster", "lab_provisioning", ["cluster_id"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "idx_student_cluster_extra_active",
        table_name="student_cluster_extra",
        postgresql_where=sa.text("revoked_at IS NULL"),
    )
