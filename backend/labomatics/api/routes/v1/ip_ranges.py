...
async def get_ip_range_allocations(
    ...
    """Récupère les allocations IP d'une plage avec infos étudiant, pagination et recherche."""
    return await service.get_allocations_paginated(ip_range_id, page, size, search)
